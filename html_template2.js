...
var wasmBinaryFile = 'html_template2.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function __ZN10ExecuteApp3runEv(
  ) {
  err('missing function: _ZN10ExecuteApp3runEv'); abort(-1);
  }
...
var asmGlobalArg = {};
var asmLibraryArg = { "_ZN10ExecuteApp3runEv": __ZN10ExecuteApp3runEv, "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__unlock": ___unlock, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
Module["asm"] = asm;
