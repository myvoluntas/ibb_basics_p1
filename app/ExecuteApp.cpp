...
void initBookDB() {
    ...
    Book book2{"Stanislas Dehaene", "Knaus", "178-435-432", "4", "Denken: Wie das Gehirn Bewusstsein schafft", "2019"};
    Book book3{"Torsten t. Will", "Rheinwerk", "978-3836243605", "1", "c++: Das umfassende Handbuch", "2018"};
    Book book4{"Scott Meyers", "O' Reilly", "978-526-423", "1", "Effective Modern C++", "2019"};

    std::vector<Book> defaultBooks{book1, book2, book3, book4};

    for (auto book : defaultBooks) {
...
inline void initCiteDB() {
    CiteStyle harvard;
    harvard.setCiteStyleName("Harvard Citestyle");
